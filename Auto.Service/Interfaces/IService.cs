...
namespace AutoClutch.Auto.Service.Interfaces
{
     ...
     where TEntity : class
    {
        ...
        System.Threading.Tasks.Task<System.Collections.Generic.IEnumerable<TEntity>> AddRangeAsync(System.Collections.Generic.IEnumerable<TEntity> entities, string loggedInUserName = null, bool dontSave = false);
        System.Threading.Tasks.Task<TEntity> AddAsync(TEntity entity, string loggedInUserName = null, bool dontSave = false);
        System.Collections.Generic.IEnumerable<TEntity> AddRange(System.Collections.Generic.IEnumerable<TEntity> entities, string loggedInUserName = null, bool dontSave = false);
        TEntity AddOrUpdate(TEntity entity, string loggedInUserName = null, bool dontSave = false);
        ...
        TEntity Update(TEntity entity, string loggedInUserName = null, bool dontSave = false);
        System.Threading.Tasks.Task<TEntity> UpdateAsync(TEntity entity, string loggedInUserName = null, bool dontSave = false);
    }
}
