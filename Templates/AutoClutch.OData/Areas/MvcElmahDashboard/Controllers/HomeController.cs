using $safeprojectname$.Areas.MvcElmahDashboard.Code;
using $safeprojectname$.Areas.MvcElmahDashboard.Models.Home;
using System;
...
namespace $safeprojectname$.Areas.MvcElmahDashboard.Controllers
{
