...
namespace $safeprojectname$.App_Start {
    public static class StructuremapWebApi {
        public static void Start() {
            ...
            dataAnnotationsModelValidatorProvider.RegisterDefaultAdapterFactory((validatorProviders, attribute) => new StructuremapDataAnnotationsModelValidatorWebApi(validatorProviders, attribute, container));

            /* Allows setter injection in IValidatableObject viewModels*/
            dataAnnotationsModelValidatorProvider.RegisterDefaultValidatableObjectAdapterFactory((validatorProviders) => new StructureMapValidatableObjectAdapterFactoryWebApi(validatorProviders, container));
        }
    }
}