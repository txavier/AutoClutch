(function () {
    ...
    angular
        .module('app')
        .controller('ContractCategoriesController', ContractCategoriesController);

    ContractCategoriesController.$inject = ['$scope', '$log', 'dataService', 'jsonPointerParseService'];

    function ContractCategoriesController($scope, $log, dataService, jsonPointerParseService) {
        var vm = this;
