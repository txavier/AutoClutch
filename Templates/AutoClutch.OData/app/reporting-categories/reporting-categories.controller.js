(function () {
    ...
    angular
        .module('app')
        .controller('ReportingCategoriesController', ReportingCategoriesController);

    ReportingCategoriesController.$inject = ['$scope', '$log', 'dataService', 'jsonPointerParseService'];

    function ReportingCategoriesController($scope, $log, dataService, jsonPointerParseService) {
        var vm = this;
        ...
        vm.orderBy = 'reportingCategoryNumber';
        vm.searchText = null;
        vm.searchCriteria = {};
