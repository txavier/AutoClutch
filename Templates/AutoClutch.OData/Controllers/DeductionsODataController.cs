...
{
    [RoutePrefix("odata/deductions")]
    public class DeductionsODataController : ODataApiController<deduction>
    {
        private IDeductionService _deductionService;

        public DeductionsODataController(IDeductionService deductionService, ILogService<deduction> logService)
