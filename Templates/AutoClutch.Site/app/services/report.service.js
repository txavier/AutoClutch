(function () {
    ...
    function reportService($http, $log, $q) {
        ...
        function getPdfReport(reportServerName, reportPath, format, parameters) {
            return $http.post(apiUrl + '?reportServerName=' + reportServerName + '&reportPath=' + reportPath + '&format=' + format, parameters, { responseType: 'arraybuffer' })
        ...
        function getHtmlReport(reportServerName, reportPath, format, parameters) {
            return $http.post(apiUrl + '?reportServerName=' + reportServerName + '&reportPath=' + reportPath + '&format=' + format, parameters)
