    ...
    public class ReportsController
    {
        public class reportsController : ApiController
        {
            ...
            public reportsController()
            {
                ...
                _reportService = container.GetInstance<IReportService>();
            }
            ...
            /// <returns></returns>
            [HttpPost]
            public HttpResponseMessage Post(string reportServerName, string reportPath, string format, List<KeyValuePair<string, string>> parameters)
            {
                HttpResponseMessage result = null;

                var byteArray = _reportService.GetReport(reportServerName, reportPath, format, parameters);
